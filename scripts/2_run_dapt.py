...
- 입력: data/processed/dapt_corpus.txt
- 모델: models/base_model (로컬 경로)
- 출력: models/dapt_adapter
"""
...
def build_trainer(
    ...
    has_eval_strategy_old = "evaluation_strategy" in sig.parameters
...
LORA_PRESETS = {
    ...
    "opt_attn":  ("q_proj","k_proj","v_proj","out_proj"),
}
...
def main():
    ...
    ap.add_argument("--data_file", type=str, default="data/processed/dapt_corpus.txt")
    ap.add_argument("--output_dir", type=str, default="models/dapt_adapter")
    ...
    ap.add_argument("--lora_preset", type=str, default="attn_only", choices=["attn_only","attn_mlp","opt_attn"])
